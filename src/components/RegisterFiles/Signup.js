        ...
        <img className='candles' src={candlepic} alt="Candlepic"/>
            ...
            <div className="form-inner">
                ...
                <div className="form-group">
                    ...
                    <input size="20" classname='inputs' type="text" name="name" id="username" value={name} placeholder="Username" onChange={(e) => {setName(e.target.value);}} />
                </div>
                <br></br>
                <div className="form-group">
                ...
                <br></br>
                <button onClick={onSignup} value="Register Account">{ loading ? 'Creating user ...' : 'Signup'} </button> 
                <br></br>
                <div className="m-5">
                    <Link to="/">
